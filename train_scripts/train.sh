...
#SBATCH -J homography_reproduce_newcode
...
#SBATCH --output=/mnt/lustre/work/bamler/zxiao29/haolong/glue-factory/log/homography_reproduce_newcode-%j.out       # File to which STDOUT will be written - make sure this is not on $HOME
#SBATCH --error=/mnt/lustre/work/bamler/zxiao29/haolong/glue-factory/log/homography_reproduce_newcode-%j.err        # File to which STDERR will be written - make sure this is not on $HOME
...
git add -u
git commit -m "homography_reproduce_newcode"
