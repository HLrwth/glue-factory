...
mkdir -p /tmp/gluefactory_train/data/datasets
squashfuse /is/cluster/fast/hli/tartan/datasets.squashfs /tmp/gluefactory_train/data/datasets
...
/is/cluster/hli/miniconda3/envs/attnvo/bin/python -m gluefactory.train "$1" --conf gluefactory/configs/superpoint+simpleglue_tartanair.yaml
